...
export class MariaDbDatabase {
  ...
  async migrate() {
    ...
    const statements = [
      ...
      `ALTER TABLE account_saves
       ADD COLUMN IF NOT EXISTS revision BIGINT UNSIGNED NOT NULL DEFAULT 0 AFTER updated_at`,
      ...
      `ALTER TABLE link_rooms
       ADD COLUMN IF NOT EXISTS invite_hash VARCHAR(128) NULL AFTER created_by,
       ADD COLUMN IF NOT EXISTS core_version VARCHAR(128) NULL AFTER invite_hash,
       ADD COLUMN IF NOT EXISTS protocol_version VARCHAR(64) NULL AFTER core_version,
       ADD COLUMN IF NOT EXISTS game_group VARCHAR(64) NULL AFTER protocol_version,
       ADD COLUMN IF NOT EXISTS expires_at BIGINT UNSIGNED NULL AFTER game_group`,
      ...
      `ALTER TABLE link_room_participants
       ADD COLUMN IF NOT EXISTS rom_id CHAR(64) NULL AFTER account_id`,
      ...
      `ALTER TABLE link_room_participants
       MODIFY COLUMN rom_id CHAR(64) NOT NULL`,
      `ALTER TABLE link_room_participants
       ADD INDEX IF NOT EXISTS link_room_participants_rom_idx (rom_id)`,
      `ALTER TABLE link_room_participants
       ADD CONSTRAINT link_room_participants_rom_fk
       FOREIGN KEY IF NOT EXISTS (rom_id) REFERENCES roms(id) ON DELETE CASCADE`,
